class PlayerTwoRacketVersus extends Phaser.GameObjects.Sprite{
    constructor(scene, x, y, texture, frame, versus = false){
    ...
    update(){
        if (!this.isHitting){
            ...
            if (keyD.isDown && this.x <= game.config.width - this.width){
                this.x += this.moveSpeed;
                this.direction = directions.RIGHT;
            }

            if (keyA.isDown && keyD.isDown) this.direction = directions.CENTER;
            if (!keyA.isDown && !keyD.isDown) this.direction = directions.CENTER;
